...
static void ApiLoadLibrary()
{
    ...
    g_pPrivacy->moduleGLES3 = apiOS_Dlopen("libGLESv2.dll");
}
    ...
    )
{
    do
    {
        ...
        Eng->glActiveTexture = (PFNGLACTIVETEXTURE)apiOS_Dlresolve(g_pPrivacy->moduleGLES3, "glActiveTextureARB");
        Eng->glGenBuffers = (PFNGLGENBUFFERS)apiOS_Dlresolve(g_pPrivacy->moduleGLES3, "glGenBuffersARB");
        Eng->glBindBuffer = (PFNGLBINDBUFFER)apiOS_Dlresolve(g_pPrivacy->moduleGLES3, "glBindBufferARB");
        Eng->glBufferData = (PFNGLBUFFERDATA)apiOS_Dlresolve(g_pPrivacy->moduleGLES3, "glBufferDataARB");
        Eng->glDeleteBuffers = (PFNGLDELETEBUFFERS)apiOS_Dlresolve(g_pPrivacy->moduleGLES3, "glDeleteBuffersARB");
        Eng->glIsBuffer = (PFNGLISBUFFER)apiOS_Dlresolve(g_pPrivacy->moduleGLES3, "glIsBufferARB");
        Eng->glBufferSubData = (PFNGLBUFFERSUBDATA)apiOS_Dlresolve(g_pPrivacy->moduleGLES3, "glBufferSubData");
        Eng->glGetBufferParameteriv = (PFNGLGETBUFFERPARAMETERIV)apiOS_Dlresolve(g_pPrivacy->moduleGLES3, "glGetBufferParameterivARB");
        ...
        Eng->glCompressedTexImage2D = (PFNGLCOMPRESSEDTEXIMAGE2D)apiOS_Dlresolve(g_pPrivacy->moduleGLES3, "glCompressedTexImage2DARB");
        Eng->glCompressedTexSubImage2D = (PFNGLCOMPRESSEDTEXSUBIMAGE2D)apiOS_Dlresolve(g_pPrivacy->moduleGLES3, "glCompressedTexSubImage2DARB");
        Eng->glCompressedTexImage3D = (PFNGLCOMPRESSEDTEXIMAGE3D)apiOS_Dlresolve(g_pPrivacy->moduleGLES3, "glCompressedTexImage3DARB");
        Eng->glCompressedTexSubImage3D = (PFNGLCOMPRESSEDTEXSUBIMAGE3D)apiOS_Dlresolve(g_pPrivacy->moduleGLES3, "glCompressedTexSubImage3DARB");
